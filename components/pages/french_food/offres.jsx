        ...
        <div className="  flex flex-col gap-4 py-10 bg-secondary">
                        ...
                        <div className=" flex flex-col lg:flex-row gap-6 items-center justify-center">
                            {
                                Array.from({ length: offres }).map((offre, index) => (
                                    <Image key={index}  src={'/img/offres/pizza.png'} width={1000} height={1000} quality={20} className=" w-70 lg:w-96" onClick={() => (offres == 3 && setOffres((prev) => prev - 1))} />
                                ))
                            }
                            <button onClick={handleClick} className={` ${offres == 3 ? 'hidden' : 'block'} relative animate-bounceCostomize cursor-pointer`}>
                                ...
                                <Image src={'/img/offres/pizza.png'} width={500} height={500} quality={20} className=" w-70 lg:w-96 opacity-25 " />
                            </button>
                        </div>
                ...
                showOffres == true && offres == 2 && (
                    <div className=" p-5 lg:p-10 flex flex-col gap-10">
                        <div className=" flex flex-col lg:flex-row gap-10 items-center justify-center">
                            <Image src={'/img/offres/juice.png'} quality={20} width={500} height={500} className=" w-52 rotate-6 animate-bounceCostomize" />
                            <div className="lg:w-1/2 text-lg lg:text-3xl font-medium uppercase space-y-2">
            ...
            }
            {
                showOffres == true && offres == 3 && (
                    <div className=" p-5 lg:p-10 flex flex-col gap-10">
                        <div className=" flex flex-col lg:flex-row gap-10 items-center justify-center">
                            <Image src={'/img/offres/pizza.png'} quality={20} width={500} height={500} className=" w-96 rotate-6 animate-bounceCostomize" />
                            <div className=" lg:w-1/2 text-lg lg:text-3xl font-medium uppercase space-y-2">
